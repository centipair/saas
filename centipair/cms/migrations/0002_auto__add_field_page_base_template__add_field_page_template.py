...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.base_template'
        db.add_column(u'cms_page', 'base_template',
                      self.gf('django.db.models.fields.CharField')(default='base.html', max_length=64),
                      keep_default=False)

        # Adding field 'Page.template'
        db.add_column(u'cms_page', 'template',
                      self.gf('django.db.models.fields.CharField')(default='page.html', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.base_template'
        db.delete_column(u'cms_page', 'base_template')
    ...
    models = {
        ...
        u'cms.page': {
            ...
            'base_template': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
