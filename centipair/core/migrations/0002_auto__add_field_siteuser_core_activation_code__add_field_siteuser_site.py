...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteUser.core_activation_code'
        db.add_column(u'core_siteuser', 'core_activation_code',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SiteUser.site_activeation_code'
        db.add_column(u'core_siteuser', 'site_activeation_code',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteUser.core_activation_code'
        db.delete_column(u'core_siteuser', 'core_activation_code')

        # Deleting field 'SiteUser.site_activeation_code'
        db.delete_column(u'core_siteuser', 'site_activeation_code')
    ...
    models = {
        ...
        u'core.siteuser': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Site']"}),
            'site_activeation_code': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
