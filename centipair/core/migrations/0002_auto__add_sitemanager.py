...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteManager'
        db.create_table(u'core_sitemanager', (
        ...
        db.send_create_signal(u'core', ['SiteManager'])


    def backwards(self, orm):
        # Deleting model 'SiteManager'
        db.delete_table(u'core_sitemanager')
